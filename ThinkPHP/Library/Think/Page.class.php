...
class Page{
    ...
    public function show() {
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page > 0 && $this->totalPages != 1){
                    $link_page .= '<li><a style="border: none;background-color: #0055bc;color: #ffffff;">' . $page . '</a></li>';
                }
            }
        }
        ...
        $page_str = str_replace(
            ...
            array($this->config['header'], $this->nowPage,$the_first , $the_end, $up_page, $link_page,  $down_page , $this->totalRows, $this->totalPages),
            $this->config['theme']);
        return "{$page_str}";
    }
}
